...
Ambrose and colleagues, in *How Learning Works: Seven Research-Based Principles for Smart Teaching* (2010), break learning down into three features that are worth discussing one at a time — ideally with at least one concrete example per feature.[^2]
...
[^2]: Ambrose, S.A., Bridges, M.W., DiPietro, M., Lovett, M.C., & Norman, M.K. (2010). *How Learning Works: Seven Research-Based Principles for Smart Teaching.* Jossey-Bass. ISBN 978-0-470-48410-4.
...
??? danger "Challenge"
    Why is learning about learning is relevant for an instructor?
