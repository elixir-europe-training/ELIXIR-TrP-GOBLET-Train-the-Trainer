---
title: "Session 2 - Design and Plan: Session, Course, and Materials"
contributors: [Patricia Palagi, Bruna Piereck, Allegra Via]
---

<!-- span style="color: red;"> <font size="20">     This session is under construction. The reference material can be found <a href="https://docs.google.com/presentation/d/13Vn2mA7N5NdgFqe64JQE1eSOu1rAkelY/edit?usp=share_link&ouid=117857355916723671329&rtpof=true&sd=true">[here....]</a>   </font>   </span -->
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - How do you currently plan and design a training session or course? (5 min, individual)" content=challenge_current_planning_practice %}
...
```mermaid
flowchart LR
    P[Plan] --> D[Design] --> DV[Develop] --> DL[Deliver] --> E[Evaluate] -.continuous improvement.-> P
```
...
<a name="part-ii-three-frameworks"></a>
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - What are Learning Outcomes? (2 min, individual)" content=challenge_define_los_yourself %}
...
```mermaid
flowchart LR
    B["Bloom's Taxonomy<br/>cognitive complexity"] --> LO[Learning Outcomes]
    K["KSAs<br/>what kind of competence"] --> LO
...
<a name="part-iii-syllabus-and-learning-experiences"></a>
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - Draft a Syllabus (12 min, individual)" content=challenge_draft_a_syllabus %}
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - Add Learning Experiences to your Syllabus (6 min, individual)" content=challenge_add_les_to_syllabus %}

---

## Session 2 - Part IV - Backward Instructional Design

<a name="part-iv-backward-instructional-design"></a>
...
```mermaid
flowchart LR
    LO["Phase 1<br/>Learning Outcomes"] --> LE["Phase 2<br/>Learning Experiences"]
    LE --> C["Phase 3<br/>Content"]
    C --> FA["Phase 4<br/>Formative Assessment"]
    FA --> EV["Phase 5<br/>Evaluation"]
    LE -.not aligned, revise.-> LO
    C -.doesn't support LEs, revise.-> LE
    FA -.doesn't monitor progress, revise.-> C
    EV -.LOs not achieved, revise.-> LO
```
...
<a name="part-v-concept-maps-and-content-reduction"></a>
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - Draw a Concept Map for your mini-lesson (15 min, individual)" content=challenge_draw_concept_map %}

---

## Session 2 - Part VI - Giving and Receiving Feedback

<a name="part-vi-giving-and-receiving-feedback"></a>
...
<a name="part-vii-developing-content-and-lesson-plan"></a>
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - Produce the content and training material for your mini-lesson (15 min, individual)" content=challenge_produce_mini_training_content %}

---

## Session 2 - Part VIII - Delivering and Evaluating the Mini-Training

<a name="part-viii-delivering-and-evaluating"></a>
...
{% endcapture %}
{% include admonition.html type="question" title="Challenge - Self-reflect on your initial LOs (2 min, individual)" content=challenge_reflect_on_initial_los %}
