...
contributors: [Allegra Via, Patricia Palagi, Jessica Lindvall]
---
...
<a name="part-ii-how-learning-works-fundamentals"></a>
...
<a name="part-iii-landscape-of-learning-theories"></a>
...
<a name="part-iv-evidence-based-principles"></a>
...
<a name="part-v-six-learning-strategies"></a>
...
<a name="part-vi-working-memory-long-term-memory"></a>
...
```mermaid
flowchart LR
    ENV["Environment<br/>things to see, hear, solve"] --> WM
    WM["Working Memory<br/>~4-7 items<br/>seconds to minutes<br/>where thinking happens"] --> LTM
    LTM["Long-term Memory<br/>vast, lasting<br/>days to a lifetime"] -.retrieval.-> WM
```
...
{% endcapture %}
{% include admonition.html type="tip" title="For trainers running this session (click to reveal - contains the answer to this exercise)" content=tip_33 collapsible=true %}
...
<a name="part-vii-dreyfus-model-and-mental-models"></a>
...
```mermaid
flowchart LR
    N2[Novice] --> CP[Competent Practitioner] --> E2[Expert]
```
...
<a name="part-viii-blooms-taxonomy"></a>
...
```mermaid
flowchart BT
    R[Remember] --> U[Understand] --> A[Apply] --> AN[Analyze] --> EV[Evaluate] --> C[Create]
```
