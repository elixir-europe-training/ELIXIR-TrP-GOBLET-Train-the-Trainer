...
contributors: [Patricia Palagi, Allegra Via, Bruna Piereck]
---
...
<a name="part-ii-what-is-assessment"></a>
...
<a name="part-iii-what-is-feedback"></a>
...
<a name="part-iv-how-and-what-to-assess"></a>
...
```mermaid
flowchart LR
    A[Assessment] --> W["WHAT?<br/>Product or Process"]
    A --> H["HOW?<br/>Formative or Summative"]
```
...
<a name="part-vi-feedback-mechanisms"></a>
...
```mermaid
flowchart LR
    FU["Feedup<br/>Where are we going?<br/>sets the target level"] --> FB["Feedback<br/>Where are we now?<br/>the gap to the target"] --> FF["Feedforward<br/>How do we close the gap?<br/>next steps"]
```
...
```mermaid
flowchart TB
    T["Task level<br/>evaluate the end result<br/>e.g. an exam, an application, a sculpture"] --> Pr["Process level<br/>evaluate the steps taken<br/>e.g. a lab procedure"]
    Pr --> M["Metacognitive level<br/>evaluate thinking, logic, rationale<br/>e.g. a debate, an essay"]
    M --> Pe["Personal level<br/>e.g. 'you are very smart'<br/>usually not effective"]
```
...
<a name="part-vii-leveraging-assessment"></a>
